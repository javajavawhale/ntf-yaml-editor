...
- ファイルディレクティブ名
- `header`、`data` など、ファイル系表の構造を表す行種別
- フィールド名
- データ型
- 桁数などのフィールド属性
...
| `[ "data", ... ]` | 行全体をレコード種別/フィールド名行として強調する |
| `[ "record-length", "12" ]` | ディレクティブ行として表示する。値の妥当性は検証しない |
| `[ "データレコード", "id", "name" ]` | 固定長ファイルのレコード種別/フィールド名行として強調する |
| `[ "データ型", "半角数字", "全角文字" ]` | 固定長ファイルのデータ型行として強調する。1列目は空でもラベルでもよい |
| `[ "フィールド長", "3", "4" ]` | 固定長ファイルのフィールド長行として強調する。1列目は空でもラベルでもよい |
