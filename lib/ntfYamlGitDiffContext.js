(function(root, factory) {
  ...
  function createRefDiffReport(options) {
    ...
    return ntfDiff.createDiffReport({
      ...
      baseRef: isWorkingTreeRef(baseRef) ? "working tree" : baseRef,
      headRef: isWorkingTreeRef(headRef) ? "working tree" : headRef,
  ...
  function diffWorkingTreeAllFiles(options) {
    ...
    const diffArgs = baseIsWorkingTree && headIsWorkingTree
