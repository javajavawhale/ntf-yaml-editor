(function(root, factory) {
  ...
  const tableBlockPrefixes = [
    "SETUP_TABLE",
    "EXPECTED_TABLE",
    "EXPECTED_COMPLETE_TABLE",
    "LIST_MAP"
  ];
  const rawRowsBlockPrefixes = [
    "SETUP_VARIABLE",
    "EXPECTED_VARIABLE"
  ];
  ...
  const blockPrefixes = tableBlockPrefixes.concat(rawRowsBlockPrefixes, rawBlockPrefixes);
